...
ADMIN_SHELL_SESSION_KEY = from_settings_or_default(
    "ADMIN_SHELL_SESSION_KEY", "django_admin_shell_output"
)
...
ADMIN_SHELL_IMPORT_DJANGO_MODULES = from_settings_or_default(
    "ADMIN_SHELL_IMPORT_DJANGO_MODULES", DEFAULT_IMPORT
)
...
ADMIN_SHELL_CLEAR_SCOPE_ON_CLEAR_HISTORY = from_settings_or_default(
    "ADMIN_SHELL_CLEAR_SCOPE_ON_CLEAR_HISTORY", False
)

ADMIN_SHELL_CALLBACK = from_settings_or_default("ADMIN_SHELL_CALLBACK", None)
